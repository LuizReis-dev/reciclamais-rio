...
<body>
    ...
    <div id="pagina">
        ...
        <input type="text" name="endereco" id="" placeholder="endereco" value="<%=empresa.getEndereco()%>">
        <input type="text" name="email" id="" placeholder="email" value="<%=empresa.getEmail()%>">
        <input type="text" name="telefone" id="" placeholder="telefone" value="<%=empresa.getTelefone()%>">
