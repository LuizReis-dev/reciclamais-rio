        ...
        <div id="pagina">
            <div class="conteiner">
                ...
                <form action="editarcatador.jsp" method="post">
                    ...
                    <input type="text" name="endereco" id="" placeholder="endereço"value="<%=catador.getEndereco()%>">

                    <input type="text" name="telefone" id="" placeholder="telefone"value="<%=catador.getTelefone()%>" >
