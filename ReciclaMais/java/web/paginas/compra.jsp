    ...
    <div id="pagina" class="compra">
        <%@include file="navegacao.html" %>
            ...
            <div class="informacao">
                <div class="conteiner-info">
                    <form id="material-form" action="" method="">
                        ...
                        <div class="material">
                            <input type="text" name="pesquisar-material" id="search-material"
                        ...
                        <div class="quantidade">
                            ...
                            <input type="text" name="produto" id="qtd-material" placeholder="Digite a quantidade..."
                                class="quantidade">
                        </div>
            ...
            <div class="modal-finalizar">
                <h3>Finalizar Compra <i class="bi bi-x fechar-form"></i></h3>
                <form class="finalizar-form">
                    <span class="sugestao-preco"></span>
                    <div class="agrupamento">
                        <span>Digite o preço desejado</span>
                        <input type="number" id="preco-final-input">
                    </div>
                    <div class="agrupamento-bonificacao">
                        <span class="valor-bonificacao"></span>
                        <input type="checkbox" name="bonificar" id="bonificar-checkbox" checked>
                    </div>
                    <span class="preco-finalizar"></span> <br>
