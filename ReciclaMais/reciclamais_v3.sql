...
--
-- Host: 127.0.0.1
-- Generation Time: 01-Jul-2022 às 16:39
...
INSERT INTO `funcionario` (`id`, `nome`, `telefone`, `usuario`, `senha`, `email`, `data_de_nascimento`, `cpf`, `funcao`) VALUES
(1, NULL, NULL, 'teste', '123', NULL, NULL, NULL, NULL);
...
--
-- Estrutura da tabela `materias_em_op`
--

CREATE TABLE IF NOT EXISTS `materias_em_op` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_operacao_comercial` int(11) NOT NULL,
  `id_material` int(11) NOT NULL,
  `total_em_kg` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_operacao_comerial_materias_em_op` (`id_operacao_comercial`),
  KEY `fk_material_materias_em_op` (`id_material`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Estrutura da tabela `operacao_comercial`
--
